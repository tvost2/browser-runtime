...
export class WasmCore {
  ...
  gpuState() {
    ...
    return {
      ...
      localPos: new Float32Array(m.HEAPF32.buffer, w.posPtr(), count * 3),
      localRot: new Float32Array(m.HEAPF32.buffer, w.rotPtr(), count * 4),
      localScale: new Float32Array(m.HEAPF32.buffer, w.scalePtr(), count * 3),
      parent: new Int32Array(m.HEAP32.buffer, w.parentPtr(), count),
      localMin: new Float32Array(m.HEAPF32.buffer, w.localMinPtr(), count * 3),
      localMax: new Float32Array(m.HEAPF32.buffer, w.localMaxPtr(), count * 3),
